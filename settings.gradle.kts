...
include(":sources:engine:analytics")
include(":ui-sandbox")
...
include(":sources:features:authorization-api")
include(":sources:features:authorization-impl")
include(":sources:features:like-api")
include(":sources:features:like-impl")
include(":sources:core:user")
include(":sources:features:profile-api")
include(":sources:features:profile-impl")
